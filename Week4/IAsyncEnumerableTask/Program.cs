...
namespace Week4.AsyncEnumerable
{
    ...
    class Program
    {
        ...
        private static async IAsyncEnumerable<JArray> RunPagedQueryAsync(GitHubClient client, string queryText, string repoName, CancellationToken cancel, IProgress<int> progress)
        {
